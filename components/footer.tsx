  ...
  return (
    <footer className="dark:border-t mt-40 dark bg-background text-foreground">
      <div className="max-w-(--breakpoint-xl) mx-auto">
        ...
        <p className="mt-6 text-muted-foreground w-[500px]">
          Kostmu adalah aplikasi saas management kos yang memudahkan penyeberangan dan pemesanan kos.
        </p>
        ...
        <div className="py-8 flex flex-col-reverse sm:flex-row items-center justify-between gap-x-2 gap-y-5 px-6 xl:px-0">
          ...
          <div className="flex items-center gap-5 text-muted-foreground">
            ...
            <Link href="#" target="_blank">
             <TikTokIcon className="h-5 w-5 text-gray-800 dark:text-white" />
